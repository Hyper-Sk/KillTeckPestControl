<section class="service-1">
    <h2>Effective Pest Solutions For <span> Your Home And Business</span> </h2>
    <p>
        With over a century of expertise in pest control, we bring extensive knowledge and experience in managing a wide range of pests across India. Leveraging our deep understanding of local environments and advanced techniques, we provide effective solutions to tackle any pest challenges. Our licensed and highly skilled technicians deliver customized pest control services tailored to your specific needs, ensuring the protection of your premises.
    </p>
    ...
    <div class="service-1-content">
        ...
        <div class="card">
            <img src="./images/pest/cockroch.jpg" alt="professional cockroach pest control treatment in kitchen and bathroom" loading="lazy">
        ...
        <div class="card">
            <img src="./images/pest/bedbug.webp" alt="bed bug pest control treatment for mattress and bedroom" loading="lazy">
        ...
        <div class="card">
            <img src="./images/pest/rat.jpg" alt="rodent control service removing rats mice bandicoots and squirrels" loading="lazy">
            <h3>Rodent Control (Rats, Mice, bandicoots and Squirrels)</h3>
            <p>
        ...
        <div class="card">
            <img src="./images/pest/mosqito-2.png" alt="mosquito pest control treatment preventing dengue and malaria mosquitoes" loading="lazy">
